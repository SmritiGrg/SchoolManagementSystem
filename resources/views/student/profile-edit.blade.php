...
<div class="content-header">
    <div class="header-left">
        <a href="{{ route('student.profile') }}" class="back-button">← Back</a>
...
<div class="form-container">
    <div class="card">
        <div class="card-body">
            <form action="{{ route('student.profile.update') }}" method="POST" class="student-form">
                @csrf
                @method('PUT')
    ...
    <div class="info-card">
        <h3>ℹ️ Note</h3>
        <ul>
            <li>Admission number, roll number, and class can only be changed by an administrator.</li>
