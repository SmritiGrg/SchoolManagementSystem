...
<div class="content-header">
    <div class="header-left">
        ...
        <p class="page-subtitle">Add a new class to the system</p>
    </div>
</div>
...
<div class="form-container">
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.classes.store') }}" method="POST" class="student-form">
                @csrf
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="academic_year" id="academic_year" value="{{ old('academic_year') }}" required>
                            <div class="year-picker @error('academic_year') is-invalid @enderror" id="year-picker-display">
                                ...
                                <span id="year-picker-label">Select Academic Year</span>
    ...
    <div class="info-card">
        <h3>📋 Guidelines</h3>
        <ul>
            <li>Class name and academic year are required</li>
            <li>Section is optional (e.g., A, B, C)</li>
            <li>The combination of class name, section, and academic year must be unique</li>
            <li>Class teacher can be assigned later</li>
        </ul>
    </div>
</div>
...
(function () {
    ...
    let pageStart = currentYear - 4; // show 12 years per page
