...
<div class="content-header">
    <div class="header-left">
        ...
        <p class="page-subtitle">Manage your assigned courses and subjects</p>
    </div>
</div>
...
<div class="card">
    <div class="card-header">
        ...
        <div class="filter-group">
            <span class="result-count">{{ $courses->total() ?? 0 }} courses found</span>
        </div>
    </div>
            ...
            <tbody>
                @forelse($courses as $course)
                    <tr>
                        ...
                        <td>
                            <div class="user-info">
                                <span class="user-name">{{ $course->subject->subject_name }}</span>
                            </div>
                        </td>
                        <td>{{ $course->schoolClass->class_name }}</td>
                        <td>
                            <span class="badge badge-code">{{ $course->schoolClass->section ?? 'N/A' }}</span>
                        </td>
                        <td>
                            <span class="badge badge-count">{{ $course->schoolClass->students_count ?? 0 }} students</span>
                        </td>
                        ...
                        <td>
                            <div class="action-buttons">
                                ...
                                <a href="#" class="btn-action btn-edit" title="Manage Course">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="action-icon">
